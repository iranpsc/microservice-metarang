...
func (h *HTTPAuthHandler) HandleCitizenRoutes(w http.ResponseWriter, r *http.Request) {
	path := r.URL.Path
...
func (h *HTTPAuthHandler) GetCitizenReferrals(w http.ResponseWriter, r *http.Request, code string) {
...
func (h *HTTPAuthHandler) GetCitizenReferralChart(w http.ResponseWriter, r *http.Request, code string) {
