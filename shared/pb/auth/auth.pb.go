...
type UpdateKYCRequest struct {
	...
	MelliCard     string                 `protobuf:"bytes,7,opt,name=melli_card,json=melliCard,proto3" json:"melli_card,omitempty"` // Public URL to uploaded image
	Video         *VideoInfo             `protobuf:"bytes,8,opt,name=video,proto3" json:"video,omitempty"`
	VerifyTextId  uint64                 `protobuf:"varint,9,opt,name=verify_text_id,json=verifyTextId,proto3" json:"verify_text_id,omitempty"`
	Gender        string                 `protobuf:"bytes,10,opt,name=gender,proto3" json:"gender,omitempty"` // male, female, other
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateKYCRequest) GetMelliCard() string {
	if x != nil {
		return x.MelliCard
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId\"\xb4\x02\n" +
	...
	"\n" +
	"melli_card\x18\a \x01(\tR\tmelliCard\x12%\n" +
	"\x05video\x18\b \x01(\v2\x0f.auth.VideoInfoR\x05video\x12$\n" +
	"\x0everify_text_id\x18\t \x01(\x04R\fverifyTextId\x12\x16\n" +
	"\x06gender\x18\n" +
	" \x01(\tR\x06gender\"3\n" +
	"\tVideoInfo\x12\x12\n" +
